        ...
        <>
            ...
            <section className='primerafila-sunrise'>
                <div className="titulo-Pfila">
                    <h1> SUNRISE ESTATES</h1>
                </div>
                <AutoContent
                    image={logosunrise}
                    title=" PIONERO EN ENERGÍAS LIMPIAS"
            ...
            <section className="cuerpo-del-contenido" >
                ...
                <div className="contenido-tercero">
                    <div className="contenido-tercer-fila">
                        ...
                        <p>
                            <span className="resaltado">Sunrise Estates </span>un proyecto que se desarrolla en una zona  <span className="resaltado">sin riesgo de inundación  </span> y sin
                            ningún tipo de restricción ambiental.
                        </p>
                    </div>
