            ...
            <div className='divcentral'>
                <div className='organizacion'>
                    ...
                    <div className='texto_sobre_empresa'>
                        Home Country Colombia es una empresa constructora inmobiliaria fundada en 2024 y ubicada en la ciudad de Cartagena, Colombia. Nuestro talento humano está calificado en el sector inmobiliario para brindar el mejor acompañamiento en su decisión . Nos especializamos en el desarrollo de proyectos residenciales y comerciales de alta calidad. Nuestro compromiso es ofrecer a nuestros clientes soluciones que brinden el máximo confort, seguridad y sostenibilidad, con un enfoque innovador.                              </div>
